...
Revision ID: e25ad4d48048
Revises: afdf2ddf31bb
Create Date: 2022-07-07 19:27:54.637732
...
revision = 'e25ad4d48048'
down_revision = 'afdf2ddf31bb'
branch_labels = None
depends_on = None
...
def downgrade() -> None:
    ...
    op.add_column('roles', sa.Column('user_name', sa.VARCHAR(), autoincrement=False, nullable=True))
